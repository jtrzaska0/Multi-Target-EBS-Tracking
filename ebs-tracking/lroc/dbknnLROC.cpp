// File        dbknnLROC.cpp
// Summary     Generate LROC curves for the DBSCAN with Kalman Nearest-Neighbors algorithm.
...
int main() {
     ...
     // Run LROC
     bgLROC<DBSCAN_KNN, KModel>(1, filenames, "DBSCAN_KNN", dataframes, k_model);
